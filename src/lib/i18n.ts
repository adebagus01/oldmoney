...
const dict = {
  ...
  reports: {
    ...
    transactionCount: { en: "{count} transactions", id: "{count} transaksi" },
  ...
  recap: {
    cardTitle: { en: "Your Recap", id: "Rekapmu" },
    cardSubtitle: { en: "Relive your money moments", id: "Lihat kembali momen keuanganmu" },
    cardButton: { en: "View", id: "Lihat" },
    pageTitle: { en: "Recap", id: "Rekap" },
    pageSubtitle: { en: "Pick a story to relive", id: "Pilih cerita untuk dilihat kembali" },
    monthlyCardTitle: { en: "This Month", id: "Bulan Ini" },
    monthlyCardSubtitle: { en: "Your {month} story", id: "Cerita {month}-mu" },
    allTimeCardTitle: { en: "All Time", id: "Sepanjang Waktu" },
    allTimeCardSubtitle: { en: "Since you started tracking", id: "Sejak kamu mulai mencatat" },
    startButton: { en: "Start", id: "Mulai" },
    close: { en: "Close", id: "Tutup" },
    noDataTitle: { en: "Not enough data yet", id: "Belum cukup data" },
    noDataCaption: {
      en: "Log a few transactions to unlock this recap.",
      id: "Catat beberapa transaksi untuk membuka rekap ini.",
    },
    backToRecaps: { en: "Back to recaps", id: "Kembali ke rekap" },
    tapHint: { en: "Tap to continue · Hold to pause", id: "Ketuk untuk lanjut · Tahan untuk jeda" },
    summarySpent: { en: "Spent", id: "Pengeluaran" },
    summaryIncome: { en: "Income", id: "Pemasukan" },
    summarySaved: { en: "Saved", id: "Ditabung" },
    summaryNet: { en: "Net", id: "Bersih" },
    summaryOverspent: { en: "Overspent", id: "Kelebihan belanja" },
    summaryTopCategory: { en: "Top category", id: "Kategori teratas" },
    summaryTransactions: { en: "Transactions", id: "Transaksi" },

    monthlyIntroEyebrow: { en: "Your recap for", id: "Rekapmu untuk" },
    monthlyIntroCaption: { en: "Let's see how it went", id: "Yuk lihat bagaimana kabarnya" },
    totalSpentEyebrow: { en: "You spent", id: "Kamu menghabiskan" },
    totalSpentCaptionUp: { en: "{pct}% more than {prevMonth}", id: "{pct}% lebih banyak dari {prevMonth}" },
    totalSpentCaptionDown: { en: "{pct}% less than {prevMonth}", id: "{pct}% lebih sedikit dari {prevMonth}" },
    totalSpentCaptionFlat: { en: "About the same as {prevMonth}", id: "Kurang lebih sama seperti {prevMonth}" },
    totalIncomeEyebrow: { en: "You brought in", id: "Kamu memasukkan" },
    netSavedEyebrowPositive: { en: "You saved", id: "Kamu menabung" },
    netSavedEyebrowNegative: { en: "You spent more than you earned by", id: "Kamu menghabiskan lebih banyak dari pemasukanmu sebesar" },
    topCategoryEyebrow: { en: "Your top category was", id: "Kategori teratasmu adalah" },
    topCategoryCaption: { en: "{pct}% of everything you spent", id: "{pct}% dari semua pengeluaranmu" },
    biggestExpenseEyebrow: { en: "Your biggest expense", id: "Pengeluaran terbesarmu" },
    biggestExpenseCaption: { en: "{category} · {date}", id: "{category} · {date}" },
    activityEyebrow: { en: "You logged", id: "Kamu mencatat" },
    activityCaption: {
      en: "transactions across {days} different days",
      id: "transaksi di {days} hari berbeda",
    },
    avgDailyEyebrow: { en: "On average, you spent", id: "Rata-rata, kamu menghabiskan" },
    avgDailyCaption: { en: "per day this month", id: "per hari bulan ini" },
    monthlyOutroEyebrow: { en: "That's a wrap on", id: "Itulah rekap untuk" },
    monthlyOutroCaption: { en: "See you next month!", id: "Sampai jumpa bulan depan!" },

    allTimeIntroEyebrow: { en: "Your Old Money story", id: "Cerita Old Money-mu" },
    allTimeIntroCaption: { en: "Since {date}", id: "Sejak {date}" },
    allTimeSpentEyebrow: { en: "You've spent a total of", id: "Kamu telah menghabiskan total" },
    allTimeIncomeEyebrow: { en: "You've earned a total of", id: "Kamu telah menghasilkan total" },
    netBalanceEyebrowPositive: { en: "Your net balance is", id: "Saldo bersihmu adalah" },
    netBalanceEyebrowNegative: { en: "You're down", id: "Kamu minus" },
    topCategoryAllTimeCaption: { en: "{pct}% of all your spending, all-time", id: "{pct}% dari semua pengeluaranmu, sepanjang waktu" },
    busiestMonthEyebrow: { en: "Your biggest spending month was", id: "Bulan dengan pengeluaran terbesarmu adalah" },
    transactionsEyebrow: { en: "You've logged", id: "Kamu telah mencatat" },
    transactionsCaption: {
      en: "transactions across {months} months",
      id: "transaksi selama {months} bulan",
    },
    topPaymentEyebrow: { en: "Your go-to payment method is", id: "Metode pembayaran andalanmu adalah" },
    allTimeOutroEyebrow: { en: "That's your story", id: "Itulah ceritamu" },
    allTimeOutroCaption: { en: "Here's to the next chapter", id: "Untuk babak berikutnya" },
  },
  settings: {
